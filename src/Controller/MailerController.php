...
class MailerController extends AbstractController
{
    ...
    public function sendActivationEmail(MailerInterface $mailer ,String $to, String $activationCode): Response
    {
        // Create a transport
        $transport = Transport::fromDsn('smtp://karat6657@gmail.com:Jd0z7k2DxNbn6QZ8@smtp-relay.brevo.com:587');
        ...
        // Set the HTML part using a Twig template
        $email->html($this->renderView('mailer/activation.html.twig', [
            'username' => 'foo',
            'address'=>$to,
            'activationCode'=>$activationCode
        ]));
